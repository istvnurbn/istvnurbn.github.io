...
2. Get the [Congo theme](https://github.com/jpanther/congo)
3. Check the `/config/_default` folder for configuration and the contents of the `/content` folder for inspiration.
